...
urlpatterns = [
    ...
    path('<int:project_id>/add_member/', views.add_member, name='project_add_member'),
    path('<int:project_id>/add_members/<int:user_id>', views.add_members, name='project_add_members'),
