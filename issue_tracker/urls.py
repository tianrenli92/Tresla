...
urlpatterns =[
    ...
    path('<int:issue_id>/delete', TemplateView.as_view(template_name="Tresla/Tresla/issue_tracker/templates/issue_tracker/issue/nice_delete.html"), name='success_deletion'),
]
